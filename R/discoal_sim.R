...
#' @param deme_join Optional. A tibble with time, pop1, pop2 columns, indicating the time (measured in generations) to join 2 particular demes. Time is numeric. Demes are numeric
